...
export class PrimaryNavItem extends Component {
  constructor(props) {
    super(props)
    this.state = { isNavOn: typeof window !== 'undefined' ? !window.location.pathname.includes(props.href) : false }
        ...
        <Link
          className={
            this.props.subNavItem
              ? 'c-primary-nav__link  c-primary-nav__link--has-children'
              : 'c-primary-nav__link'
          }
          to={this.props.href}
        ...
        >
          ...
          {this.props.subNavItem && (
            ...
            >
              ...
              <path d="M2 3L0 5l3 3-3 3 2 2 5-5-5-5z" />
            </svg>
          )}
        </Link>
