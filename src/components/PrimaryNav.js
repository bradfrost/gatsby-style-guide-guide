            ...
            <PrimarySubNavItem
              ...
              subSubNavItems={
                <ul className="c-primary-nav__sublist">
                  {data
                    .filter(
                      post => post.node.frontmatter.group === 'components'
                    )
                    .filter(
                      post =>
                        post.node.frontmatter.subgroup === 'blocks-and-cards'
                    )
                    .filter(
                      post =>
                        post.node.frontmatter.layout === 'component-category'
                    )
                    .map(({ node: post }) => {
                      return (
                        <PrimarySubNavItem
                  ...
                  {data
                    ...
                    .filter(
                      post =>
                        post.node.frontmatter.layout === 'component-detail'
                    )
                    .map(({ node: post }) => {
                      return (
                        <PrimarySubNavItem
              ...
              subSubNavItems={
                <ul className="c-primary-nav__sublist">
                  {data
                    ...
                    .filter(
                      post => post.node.frontmatter.subgroup === 'buttons'
                    )
                    .filter(
                      post =>
                        post.node.frontmatter.layout === 'component-category'
              ...
              subSubNavItems={
                <ul className="c-primary-nav__sublist">
                  {data
                    ...
                    .filter(
                      post =>
                        post.node.frontmatter.subgroup === 'charts-and-graphs'
                    )
                    .filter(
                      post =>
                        post.node.frontmatter.layout === 'component-category'
              ...
              subSubNavItems={
                <ul className="c-primary-nav__sublist">
                  {data
                    ...
                    .filter(
                      post => post.node.frontmatter.subgroup === 'form-controls'
                    )
                    .filter(
                      post =>
                        post.node.frontmatter.layout === 'component-category'
              ...
              subSubNavItems={
                <ul className="c-primary-nav__sublist">
                  {data
                    ...
                    .filter(
                      post =>
                        post.node.frontmatter.subgroup === 'headers-and-footers'
                    )
                    .filter(
                      post =>
                        post.node.frontmatter.layout === 'component-category'
              ...
              subSubNavItems={
                <ul className="c-primary-nav__sublist">
                  {data
                    ...
                    .filter(
                      post => post.node.frontmatter.subgroup === 'interactive'
                    )
                    .filter(
                      post =>
                        post.node.frontmatter.layout === 'component-category'
              ...
              subSubNavItems={
                <ul className="c-primary-nav__sublist">
                  {data
                    ...
                    .filter(
                      post =>
                        post.node.frontmatter.subgroup ===
              ...
              subSubNavItems={
                <ul className="c-primary-nav__sublist">
                  {data
                    ...
                    .filter(
                      post => post.node.frontmatter.subgroup === 'messaging'
                    )
                    .filter(
                      post =>
                        post.node.frontmatter.layout === 'component-category'
              ...
              subSubNavItems={
                <ul className="c-primary-nav__sublist">
                  {data
                    ...
                    .filter(
                      post => post.node.frontmatter.subgroup === 'navigation'
                    )
                    .filter(
                      post =>
                        post.node.frontmatter.layout === 'component-category'
        ...
        subNavItem={
          <ul className="c-primary-nav__sublist">
            {data
              ...
              .filter(
                post => post.node.frontmatter.layout === 'utilities-index'
              )
              .map(({ node: post }) => {
                return (
                  <PrimarySubNavItem
            ...
            {data
              .filter(post => post.node.frontmatter.group === 'utilities')
              .filter(
                post => post.node.frontmatter.layout === 'component-detail'
              )
              .map(({ node: post }) => {
                return (
                  <PrimarySubNavItem
