      ...
      <Layout>
        <div className="l-container">
          ...
          <Breadcrumbs
            ...
            subgroup={post.frontmatter.subgroup}
          />
          ...
          {post.frontmatter.variations &&
            post.frontmatter.variations.length > 1 && (
              <Tabs>
                    ...
                    <Tabs styleModifier="ads-u-margin-bottom-large">
                      <Tab label="React">
                        <div className="pattern-code">
                          <Button
                            styleModifier="pattern-code-copy-btn"
                            text="Copy"
                            dataClipboardTarget={
                              '#pattern-code-' + item.component
                            }
                          />
                          <pre className="highlight pattern-code-block language-markup">
                            <code
                              className="code language-markup"
                              id={'pattern-code-' + item.component}
                            >{`
                  ...
                  <Tab label="React">
                    <div className="pattern-code">
                      <Button
                        styleModifier="pattern-code-copy-btn"
                        text="Copy"
                        dataClipboardTarget={'#pattern-code-' + item.component}
                      />
                      <pre className="highlight pattern-code-block language-markup">
                        <code
                          className="code language-markup"
                  ...
                  {post.frontmatter.use &&
                    post.frontmatter.use.map((item, index) => (
                      <ContentBlock
                        ...
                        title={item.title}
                        description={item.description}
                        styleModifier="c-content-block--success"
                      />
                    ))}
                </li>
                <li className="l-grid__item">
                  {post.frontmatter.altUse &&
                    post.frontmatter.altUse.map((item, index) => (
                      <ContentBlock
                        ...
                        title={item.title}
                        description={item.description}
                        styleModifier="c-content-block--error"
                      />
                    ))}
                </li>
              </ul>
          ...
          {post.frontmatter.classes && (
            <Table
              ...
              tbody={post.frontmatter.classes.map((item, index) => (
